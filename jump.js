var link, jsGame; (function() {
    ...
    String.format || (String.format = function() {
        ...
        for (var a = arguments[0] || "", c, i = 1, v = arguments.length; i < v; i++) c = RegExp("\\{" + (i - 1) + "\\}", "gm"),
    ...
    String.getByteLength || (String.getByteLength = function(a) {
        ...
        i = a || "",
        v = i.length,
        a = 0; a < v; a++) c = 0 <= i.charCodeAt(a) & 255 >= i.charCodeAt(a) ? c + 1 : c + 2;
        return c
    });
    if (!Array || !Array.prototype) Array.prototype = {};
    Array.prototype.indexOfAttr = function(a, c) {
        for (var i = (typeof a).toLowerCase(), v = -1, b = 0, d = this.length; b < d; b++) if ("string" == i && this[b][a] == c || "number" == i && this[b] == a) {
            v = b;
            break
        }
        return v
    ...
    l = {
        ...
        setAudio: function(a, c, i, v, b, d) {
            if (!a || !c) return ! 1;
            y[a] || (c = new Audio(c + ("" != L ? "?v=" + L: "")), c.id = a, c.autoplay = v, c.preload = b, c.autobuffer = d, c.loop = i, y[c.id] = c)
        },
    ...
    N,
    m = jsGame = link = {
        init: function(a, c) { ! a && !c ? (this.version = 1, this.request.init(), this.canvas.initDevice(), this.localStorage.init(), this.sessionStorage.init()) : (s = a, t = c);
            return this
        },
        ...
        objExtend: function() {
            ...
            b = !1,
            d;
            "boolean" === typeof a && (b = a, a = arguments[1] || {},
            c = 2);
            "object" !== typeof a && (a = {});
            i == c && (a = this, --c);
            if (!arguments[1]) return a;
            for (; c < i; c++) if (null != (d = arguments[c])) for (var e in d) {
                var h = a[e],
                g = d[e];
        ...
        clone: function(a) {
            var c = a || [];
            if ("object" == typeof c) if (void 0 != c.length) for (var a = [], i = 0, b = c.length; i < b; i++) void 0 !== c[i] && (a[i] = null != c[i] && "object" == typeof c[i] ? void 0 != c[i].length ? c[i].slice(0) : c[i] : c[i]);
            else for (i in a = {},
        ...
        comm: {
            ...
            getArray: function(a, c) {
                ...
                Z = a;
                for (var i = 0; i < ja; i++) Y.push(Z % 10),
                Z = parseInt(Z / 10);
                c || Y.reverse();
                return Y
            },
            ...
            createPath: function(a, c, i, b, d) {
                for (var e = [], a = (i || 0) - (a || 0), g = (b || 0) - (c || 0), c = Math.sqrt(Math.pow(a, 2) + Math.pow(g, 2)), b = d = d || 5, h = i = 0, f = 180 * (Math.atan2(g, a) / Math.PI), f = 0 <= f ? f: f + 360; b < c + d;) b = b > c ? c: b,
        ...
        pageLoad: function(a) {
            null == f.pageLoad && (f.pageLoad = a, window.addEventListener("load",
            function() {
                m.canvas.init();
                ...
                "ipad" == a || "iphone" == a ? (d.focused = !0, window.addEventListener("pageshow", l.pageFocus, !1), window.addEventListener("pagehide", l.pageUnFocus, !1)) : ("firefox" == a && (d.focused = !0), window.addEventListener("focus", l.pageFocus, !1), window.addEventListener("blur", l.pageUnFocus, !1));
        ...
        canvas: {
            ...
            pass: function(a, c, i) {
                ...
                E[a] || (b = this.base().getDom(a) || document.createElement("canvas"), E[a] = null, delete E[a], E[a] = b.getContext("2d"), b.width = c ? c: s, b.style.width = parseInt(b.width * x) + "px", b.height = i ? i: t, b.style.height = parseInt(b.height * x) + "px", w[a] = null, delete w[a], w[a] = b);
                k = E[a];
                k.font = p;
                H = w[a];
                R = parseInt(H.width);
            ...
            drawImage: function(a, c, i, b, d, e, g, h, f, q) {
                ...
                else if (null != j.src) null != h && (c = 0 > c ? 0 : c, h = 0 >= h ? 0.1 : h),
                ...
                j.loaded && (b ? d ? q ? (G = l.getAnchor(e, g, h, f, q), k.drawImage(j, c, i, b, d, G.x, G.y, h, f)) : k.drawImage(j, c, i, b, d, e, g, h, f) : (G = l.getAnchor(c, i, j.width, j.height, b), k.drawImage(j, G.x, G.y)) : k.drawImage(j, c, i));
                else if ((a = K[a]) && !a.inited) l.setImage(a.id, a.src, a.benchId, a.bench, a.cache),
                a.inited = !0;
                return this
            },
            ...
            drawCache: function(a, c, b, d, e, g, h, f, j, q) {
                if (a = w[a]) null != f && (c = 0 > c ? 0 : c, f = 0 >= f ? 0.1 : f),
                ...
                d ? e ? q ? (G = l.getAnchor(g, h, f, j, q), k.drawImage(a, c, b, d, e, G.x, G.y, f, j)) : k.drawImage(a, c, b, d, e, g, h, f, j) : (G = l.getAnchor(c, b, a.width, a.height, d), k.drawImage(a, G.x, G.y)) : k.drawImage(a, c, b);
                return this
            },
            ...
            drawNumber: function(a, c, b, d, e, g, f, h, j) {
                ...
                } else if (!0 == f) for (f = 0; f < q; f++) this.drawImage(c, parseInt(a.charAt(f)) * b, 0, b, d, e + f * h, g, h, j);
                else if (!1 == f) for (f = q - 1; 0 <= f; f--) this.drawImage(c, parseInt(a.charAt(f)) * b, 0, b, d, e - (q - 1 - f) * h, g, h, j, m.graphics.ANCHOR_RT);
                return this
            },
            moveTo: function(a, c) {
                k.moveTo(a, c);
        ...
        pushImage: function(a) {
            if (X) return this;
            for (var c, b = 0,
            d = a.length; b < d; b++) if ((c = a[b]) && !S[c.id]) S[c.id] = !0,
            F.push(a[b]);
            return this
        },
        loadImage: function(a) {
            if (f.gameFlow != z.loadImage && 0 < a.length) {
                ...
                J = F.length;
                for (var a = q = 0,
                c; c = F[a]; a++) u[c.id] ? q++:l.setImage(c.id, c.src, c.benchId)
            }
            return this
        },
        asyncImage: function(a) {
            for (var c, b = 0,
            d = a.length; b < d; b++) c = a[b] || {},
            K[c.id] || (K[c.id] = c);
            return this
        },
        verImage: function(a) {
        ...
        clearAsyncImageCache: function() {
            try {
                var a, c, b;
                for (b in u) if (a = u[b]) if (c = K[b]) c.inited = !1,
    ...
    link.action.Role.prototype.action = function() {
        ...
        if (e) {
            ...
            this.aR = g.aR;
            this.bR = g.bR;
            if (0 < this._path.length) j = this._path.shift(),
            h = j[0] || 0,
            j = j[1] || 0,
    ...
    link.action.Role.prototype.render = function() {
        ...
        if (b && this._fA) {
            ...
            for (var t = 0; t < n; t++) j = this.rects[e[t][0]][e[t][1]],
    ...
    link.action.Role.prototype.setStep = function(b) {
        this.step = b || 0;
        for (var e = 0,
        g = this.sprites.length; e < g; e++) this.sprites[e].setStep(b);
        return this
    };
    ...
    link.action.Role.prototype.setLoop = function(b) {
        for (var e = 0,
        g = this.sprites.length; e < g; e++) this.sprites[e].setLoop(b);
        return this
    };
    ...
    link.action.Fragment.prototype.queue = function() {
        0 < this.sprites.length ? 0 < this.sprites[0].frames.length && (0 >= this.sprites[0].runStep ? (this.sprites[0].runStep = this.sprites[0].step, C = this.sprites[0].frames.shift(), 0 == this.sprites[0].frames.length && this.sprites.shift()) : (C = this.sprites[0].getFrame(), this.sprites[0].runStep--)) : C = null;
        return C
    };
    ...
    g.pageLoad(function() {
        ...
        x = {
            ...
            init: function(b, d) {
                ...
                null == b && (this.birdSpriteId++, this.birdSpriteId %= 3, this.bgId++, 2 < this.bgId && (this.bgId = 1));
                this.screenFlush = [];
            ...
            objesAction: function() {
                ...
                case "ready":
                    ...
                    break;
                case "run":
                    for (var b = this.obses.length - 1,
                    d; d = this.obses[b]; b--) d.x += this.speed,
                    this.bird.collisionInput(d.x, d.y, d.width, d.height, "bR") && this.gameOver(),
                    -52 >= d.x && this.obses.splice(b, 1);
                    this.obsCurrentFrame++==this.obsFrameNum && (this.obsCurrentFrame = 0, this.obsDate = _newDate, this.popObs())
                }
                if ((b = this.obses[0]) && b.id != this.scoreObsId && b.x < this.bird.x - 26) this.scoreObsId = b.id,
                this.score++;
                return this
            },
            objesRender: function() {
                for (var b, d = 0,
                e; e = this.obses[d]; d++) b = e.imgObj,
        ...
        J = {
            ...
            action: function() {
                0 < this.values.length && (this.opacity = this.values.shift(), 0 == this.values.length && this.callBack && this.callBack());
                return this
            },
            render: function() {
...
var FlappyBird, FlappyBirdNameSpace = {}; (function(g) {
    g.asyncImage([{
        id: "s2",
        src: "img/s2.png"
    }]);
